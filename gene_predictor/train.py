...
def main():
    ...
    parser.add_argument('--stride', type=int, default=330, help='Window stride')
    parser.add_argument('--num-windows', type=int, default=0, help='Number of windows to train with; if 0, do not sample windows')
    ...
    parser.add_argument('--start-weight', type=float, default=16.0, help='Weight for START class')
    parser.add_argument('--stop-weight', type=float, default=8.0, help='Weight for STOP class')
    parser.add_argument('--dss-weight', type=float, default=2.0, help='Weight for DSS class')
    ...
    parser.add_argument('--dss-neg-weight', type=float, default=2.0, help='Negative class weight for DSS (BCE)')
    parser.add_argument('--ass-neg-weight', type=float, default=2.0, help='Negative class weight for ASS (BCE)')

    # Alpha weights per head/class (only used in event-head-bce)
    parser.add_argument('--start-alpha', type=float, default=1.0, help='Alpha weight for START head (BCE)')
    parser.add_argument('--stop-alpha', type=float, default=2.0, help='Alpha weight for STOP head (BCE)')
    parser.add_argument('--dss-alpha', type=float, default=3.0, help='Alpha weight for DSS head (BCE)')
    parser.add_argument('--ass-alpha', type=float, default=3.0, help='Alpha weight for ASS head (BCE)')
    ...
    def mk_training_cb(val_loader):
        ...
        if num_event_heads > 0:
            ...
            if alpha_targets:
                cbs.append(
                    AlphaTargetAdjustCallback(
                        alpha_by_class=alpha_by_class,
                        head_class_ids=head_class_ids,
                        alpha_targets_by_class=alpha_targets,
